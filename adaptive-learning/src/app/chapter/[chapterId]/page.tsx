                ...
                {section.locked ? (
                  <div className="p-5 flex items-center gap-4" aria-label="Locked section">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500">
                        {section.sectionId} &mdash; {section.title}
                      </p>
                      <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">Complete the previous section to unlock</p>
                    </div>
                  </div>
                ) : (
                  <Link
