  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Trouble loading this chapter</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          We had trouble loading the chapter content. Please try again or head back to the chapters list.
        </p>
